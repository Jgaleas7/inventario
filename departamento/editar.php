...
$mbd=DB::connect();DB::disconnect();
         $proof=$mbd->query("SELECT * from departamento WHERE id_departamento='$id'");
...
<div id="cuerpo" class="col-md-8" >
    ...
    <div class="col-md-8 col-md-offset-3" >
        <div class="box box-primary">
            ...
            <form role="form">
                <div class="box-body">
                    <input type="hidden" id="id" value="<?php if (isset($row["id_departamento"])) echo  $row["id_departamento"];?>">

                    <div class="form-group">
                        <label for="marca">Nombre Departamento</label>
                        <input type="text" class="form-control " id="departamento" value="<?php if (isset($row["nombre_dep"])) echo $row["nombre_dep"]; ?>"placeholder="nombre departamento eje: Producion">
                    </div>
